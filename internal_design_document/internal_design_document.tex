...
\begin{description}
\item [メソッド名 :] login
\item [入力 :] メールアドレス、パスワード
\item [出力 :] ユーザ用のログインページ
\item [処理 :]\mbox{}
  \begin{enumerate}
  \item ユーザのメールアドレスとパスワードを入力する。
 \item 入力内容が確認されるとユーザ用のログインページに戻る。
 \end{enumerate}
\end{description}
...
\item [処理 :]\mbox{}
  \begin{enumerate}
  \item マイページにおける編集する設定情報を入力する。
 \item 設定情報が確認されたら設定詳細ページに戻る。
 \end{enumerate}
\end{description}
