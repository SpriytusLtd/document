...
\multirow{2}{*}{ユーザ登録} & /user/new
& GET & \multirow{12}{*}{Userコントローラ} \\\cline{3-3}
 & /user/create & POST & \\\cline{1-3}
...
& GET & \\\cline{3-3}
 ...
 & GET & \multirow{13}{*}{Storeコントローラ} \\\cline{3-3}
  & & POST &\\\cline{1-3}
 \multirow{2}{*}{店舗登録} & /store/new
 & GET &\\\cline{3-3}
  & /store/create & POST &\\\cline{1-3}
...
stores/registration.html.erb & /store/registration & 店舗用の登録ページです。 \\\hline
stores/login.html.erb & /login\_store & 店舗用のログインページです。\\\hline
\multirow{2}{*}{stores/index.html.erb} & \multirow{2}{*}{/store/:store\_name} & 店舗のマイページのトップページです。 \\\hline
\multirow{2}{*}{stores/review.html.erb} & \multirow{2}{*}{/store/:store\_name/review} & 店舗のマイページのレビューページです。 \\\hline
\multirow{2}{*}{stores/config.html.erb} & \multirow{2}{*}{/store/:store\_name/config} & 店舗のマイページの詳細設定用ページです。 \\\hline
\end{tabular}
\end{center}
\end{table}
