...
\item [処理 :]\mbox{}
  \begin{enumerate}
 \item 登録情報をサーバに送信します。
 \item 登録情報の正しいかどうかを判定し、不備があればエラーを返します。
 \item 登録情報が正しければデータベースに登録し、ユーザマイページを出力します。
 \end{enumerate}
\end{description}
...
\begin{description}
\item [メソッド名 :] delete_favorite
\item [入力 :] 削除対象パラメータ
\item [出力 :] 200:OK
\item [処理 :]\mbox{}
  \begin{enumerate}
  \item 削除方法を判断します。
 \item 削除対象パラメータを入力し削除結果を抽出します。
 \item 200:OKを出力します。
 \end{enumerate}
\end{description}
...
\begin{description}
\item [メソッド名 :] delete_reviews
\item [入力 :] 削除対象パラメータ
\item [出力 :] 200:OK
\item [処理 :]\mbox{}
  \begin{enumerate}
  \item 削除方法を判断します。
 \item 削除パラメータを入力し削除結果を抽出します。
 \item 200:OKを出力します。
 \end{enumerate}
\end{description}
...
\item [処理 :]\mbox{}
  \begin{enumerate}
  \item マイページにおける編集する設定情報を入力します。
 \item 設定情報が確認されたら設定詳細ページを出力します。
 \end{enumerate}
\end{description}
