...
ログイン（ユーザ） & /login\_user & GET & \\\hline
 & & POST & メールアドレスとパスワードを送信します。 \\\hline
...
店舗マイページ（詳細） & /store:store\_name & GET & \\\hline
店舗マイページ（レビュー） & /store:store\_name & GET & \\\hline
お酒（詳細） & /detuil:drink\_name & GET & \\\hline
お酒（レビュー） & /detuil:drink\_name/review & GET & \\\hline
店舗マイページ（編集） & /edit:store\_name & DELETE & 削除対象をパラメータで指定します。\\\hline
店舗（レビュー） & /edit:store\_name/review & GET & \\\hline
