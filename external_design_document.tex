...
内容としては、ユーザIDを入力し、選択したお酒の味を十字のチャート図で評価します。十字のチャート図においては二組の形容詞対を十字に対応させ、そのチャート図内で評価を行います（図\ref{fig:15}）。
...
内容としては、ユーザIDを入力し、選択した店舗の全体の雰囲気の良し悪しを０〜５の６段階の数値で評価します。
